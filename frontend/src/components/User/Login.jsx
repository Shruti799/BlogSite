...
//             {/* login with google */}
//             <a
//               href="https://blogsite-y4ve.onrender.com/api/v1/users/auth/google"
      ...
      <div className="w-full p-4">
        <div className="flex flex-col justify-center py-24 max-w-md mx-auto h-full">
          <form onSubmit={formik.handleSubmit}>
            ...
            {/* Google Login Button - ✅ Updated with Correct Redirect URI */}
            <a
              href="https://blogsite-y4ve.onrender.com/api/v1/users/auth/google"
              className="h-14 inline-flex items-center justify-center gap-2 py-4 px-6 rounded-full bg-white w-full text-center border border-gray-100 shadow hover:bg-gray-50 focus:ring focus:ring-purple-200 transition duration-200"
            >
              ...
              <span className="font-bold font-heading">Sign in with Google</span>
            </a>
          </form>
        </div>
      </div>
